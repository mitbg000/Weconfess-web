...
class HomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), [
            ...
            'genders_id' => 'required',
            'age' => 'required',
            'photo' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:15000',
            'public' => 'nullable'
        ...
        else $user = User::where("email", 'anonymous@weconfess.net')->first();
    ...
    public function show($id, $slug)
    {
        ...
        return view('layouts.item.show')->with([
            'site_name' => Settings::find('site_name')->value,
            'site_description' => $item->story ?? Settings::find('site_description')->value,
            'site_og_image' => @$item->photo->filename ? asset('storage/app/'. @$item->photo->filename ?? '') : null  ,
